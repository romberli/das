...
func initInfoMiddlewareClusteMessage() {
	message.Messages[InfoMetadataGetMiddlewareClusterAll] = config.NewErrMessage(message.DefaultMessageHeader, InfoMetadataGetMiddlewareClusterAll, "metadata: get middleware clusters all completed. id: %s")
	...
	message.Messages[InfoMetadataGetMiddlewareClusterByName] = config.NewErrMessage(message.DefaultMessageHeader, InfoMetadataGetMiddlewareClusterByName, "metadata: get middleware cluster by name completed. id: %s")
...
func initErrorMiddlewareClusteMessage() {
	...
	message.Messages[ErrMetadataGetMiddlewareClusterByName] = config.NewErrMessage(message.DefaultMessageHeader, ErrMetadataGetMiddlewareClusterByName, "metadata: get middleware cluster by name failed. id: %s\n%s")
