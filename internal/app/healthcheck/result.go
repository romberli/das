...
// Set sets healthCheck with given fields, key is the field name and value is the relevant value of the key
...
// MarshalJSON marshals healthCheck to json string
func (r *Result) MarshalJSON() ([]byte, error) {
	return common.MarshalStructWithTag(r, constant.DefaultMarshalTag)
}

// MarshalJSONWithFields marshals only specified field of the healthCheck to json string
